...
import ir.orangehat.movieinfo.di.ViewModelProviderFactory;
...
public class HomeActivity extends DaggerAppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        HomeViewModel homeViewModel = ViewModelProviders.of(this,providerFactory).get(HomeViewModel.class);
